...
import hardwareVideo from "../assets/Animations/Candibell Sensor Start Tracking.mp4";
import filtrationVideo from "../assets/Animations/filter.mp4";
import autoVideo from "../assets/Animations/Idea into Book Machine.mp4";
import sensorsVideo from "../assets/Animations/camera.mp4";
...
export const iconMap = {
  hardware: <VideoIcon src={hardwareVideo} style={{ width: 60, height: 60, objectFit: "contain" }} />,
  filtration: <VideoIcon src={filtrationVideo} style={{ width: 60, height: 60, objectFit: "contain" }} />,
  auto: <VideoIcon src={autoVideo} style={{ width: 60, height: 60, objectFit: "contain" }} />,
  sensors: <VideoIcon src={sensorsVideo} style={{ width: 60, height: 60, objectFit: "contain" }} />,
};
